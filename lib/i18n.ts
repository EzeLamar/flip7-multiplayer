...
export const translations = {
  en: {
    ...
    localMultiplayerDesc: "Play on this device — pass & play",
    yourName: "Your name",
    gameCode: "Game code",
    ...
    localPlayersTitle: "Local Multiplayer",
    addPlayer: "+ Add player",
    removePlayer: "Remove",
    startLocalGame: "Start Local Game",
    backToMenu: "← Back",
    minPlayers: "At least 2 players required",
    passDeviceTitle: (name: string) => `Pass device to ${name}`,
    passDeviceReady: "I'm ready!",
    gameHint:
  ...
  es: {
    ...
    localMultiplayerDesc: "Jugá en este dispositivo — pasate el teléfono",
    yourName: "Tu nombre",
    ...
    localPlayersTitle: "Multijugador Local",
    addPlayer: "+ Agregar jugador",
    removePlayer: "Quitar",
    startLocalGame: "Iniciar Partida Local",
    backToMenu: "← Volver",
    minPlayers: "Se necesitan al menos 2 jugadores",
    passDeviceTitle: (name: string) => `Pasá el dispositivo a ${name}`,
    passDeviceReady: "¡Listo!",
    gameHint:
