...
export const translations = {
  en: {
    ...
    modeCustom: "Custom",
    modeCustomDesc: "Pick exactly which power-up cards to include.",
    modeVengeanceBadge: "VENGEANCE",
    modeClassicBadge: "CLASSIC",
    modeCustomBadge: "CUSTOM",
    customCardsTitle: "Power-up Cards",
    customGroupClassic: "Classic Specials",
    customGroupVengeanceAction: "Vengeance Action Cards",
    customGroupVengeanceNumber: "Vengeance Number Cards",
    customGroupVengeanceMod: "Vengeance Modifier",
    customSelectAll: "All",
    customSelectNone: "None",
  ...
  es: {
    ...
    modeCustom: "Custom",
    modeCustomDesc: "Elegí exactamente qué cartas de powerup incluir.",
    modeVengeanceBadge: "VENGEANCE",
    modeClassicBadge: "CLÁSICO",
    modeCustomBadge: "CUSTOM",
    customCardsTitle: "Cartas de Powerup",
    customGroupClassic: "Especiales Clásicas",
    customGroupVengeanceAction: "Cartas de Acción Vengeance",
    customGroupVengeanceNumber: "Números Especiales Vengeance",
    customGroupVengeanceMod: "Modificador Vengeance",
    customSelectAll: "Todas",
    customSelectNone: "Ninguna",
